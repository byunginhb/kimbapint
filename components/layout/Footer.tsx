    ...
    <footer className="border-t border-gray-800 bg-gray-900/50">
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8 mb-6">
          ...
          <span className="text-red-400 text-xs font-mono">Don&apos;t Trust</span>
        ...
        <div className="text-center mb-4">
          <p className="text-gray-500 text-xs font-mono leading-relaxed max-w-2xl mx-auto">
            이 사이트는 <span className="text-gray-400">풍자적/교육적</span> 목적으로 제작되었습니다.
            실제 군사 정보와 무관하며, 모든 데이터는 가상입니다.
          </p>
        </div>
